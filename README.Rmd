...
benchwarmers <- get_ep_for_league(league_number = 570437, gameweek = get_current_gw_number())
...
Or visualising my minileague point over time, using `get_league_entries()` information:
