...
pl_style <- function() {
  ...
  ggplot2::theme(
    ...
    # removes a title and backround for it and sets the requirements for
    # any text within the legend. The legend may often need some more manual
    # tweaking when it comes to its exact position based on the
    # plot coordinates.
    legend.position = "top",
    legend.text.align = 0,
    ...
    # In some cases, axis lines and axis ticks are things we would want
    # to have in the chart - the cookbook shows examples of how to do so.
    ...
    # plots to white, removing the standard grey ggplot background colour
